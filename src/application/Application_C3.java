...
public class Application_C3 {
	...
	private void run() {
		...
		System.out.println();
		StringBuffer sb2 = new StringBuffer("Customers:\n");
		Function<Stream<Customer>, Stream<Customer>> customerStream = sortednames -> sortednames.sorted((a,b) -> a.getLastName().compareTo(b.getLastName()));
		printCustomers(sb2, customers, customerStream);
		System.out.println(sb2);
		System.out.println();
		StringBuffer sb3 = new StringBuffer("Customers:\n");
		Function<Stream<Customer>, Stream<Customer>> customerStream2 = filterednames -> filterednames.sorted((a,b) -> a.getLastName().compareTo(b.getLastName())).filter(s -> s.getId()/100000 == 4 );
		printCustomers2(sb3, customers, customerStream2);
	...
	public StringBuffer printCustomers2(StringBuffer sb, final Collection<Customer> customers,
			final Function<Stream<Customer>, Stream<Customer>> customerStream2  
	) {
		if(customers==null)
			return sb;
		//
		final StringBuffer sb_ = sb==null? new StringBuffer() : sb;
		//
		(customerStream2 != null? customerStream2.apply(customers.stream()) : customers.stream())
			.forEach(c -> printCustomer(sb_, c));
		//
		return sb_;
	}
